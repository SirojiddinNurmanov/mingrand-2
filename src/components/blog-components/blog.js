                        ...
                        <div className="col-lg-8">
                            <div className="single-blog-inner">
                                <div className="thumb">
                                    <img
                                        src={
                                            publicUrl + "assets/img/blog/1.png"
                                        }
                                        alt="img"
                                    />
                                </div>
                                <div className="details">
                                    ...
                                    <p>
                                        ...
                                        dolor sit amet, consectetur et
                                        adipisicing eiLorem ipsum dolor sit
                            ...
                            <div className="single-blog-inner">
                                <div className="thumb">
                                    <img
                                        src={
                                            publicUrl + "assets/img/blog/2.png"
                                        }
                                        alt="img"
                                    />
                                </div>
                                ...
                                <div className="details">
                                    ...
                                    <h3>
                                        <Link to="/blog-details">
                                            ...
                                            consectetur et adipisicing eiLorem
