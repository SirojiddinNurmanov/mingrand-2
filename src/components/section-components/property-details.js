                                ...
                                <div className="col-lg-7">
                                    ...
                                    <p>
                                        <img
                                            ...
                                            alt="img"
                                        />{" "}
                                        New York 261, Sam Road, Right Side real
                                        estate{" "}
                                    </p>
                                    <ul>
                                        <li>3 Bedroom</li>
                            ...
                            <div className="single-thumbnail-slider">
                                <div className="slider-item">
                                    <img
                                        src={
                                            publicUrl +
                                            "assets/img/project-single/1.png"
                                        }
                                        alt="img"
                                    />
                                </div>
                                <div className="slider-item">
                                    <img
                                        src={
                                            publicUrl +
                                            "assets/img/project-single/2.png"
                                        }
                                        alt="img"
                                    />
                                </div>
                                <div className="slider-item">
                                    <img
                                        src={
                                            publicUrl +
                                            "assets/img/project-single/3.png"
                                        }
                                        alt="img"
                                    />
                                </div>
                                <div className="slider-item">
                                    <img
                                        src={
                                            publicUrl +
                                            "assets/img/project-single/4.png"
                                        }
                                        alt="img"
                                    />
                                </div>
                                <div className="slider-item">
                                    <img
                                        src={
                                            publicUrl +
                                            "assets/img/project-single/5.png"
                                        }
                                        alt="img"
                                    />
                                </div>
                            ...
                            <div className="single-property-details-inner">
                                ...
                                <div className="single-property-grid">
                                    ...
                                    <img
                                        src={
                                            publicUrl +
                                            "assets/img/project-single/6.png"
                                        }
                                        alt="img"
                                    />
                                </div>
                                    ...
                                    <div
                                        ...
                                        style={{
                                            background:
                                                "url(" +
                                                publicUrl +
                                                "assets/img/project-single/8.png)",
                                        }}
                                    >
                                        <a
                                            className="play-btn"
